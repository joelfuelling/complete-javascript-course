...
let sum = 0;
for (let [oddx, oddy] of gameOdds) {
  sum += oddy;
}
let avgOdd = sum / gameOdds.length;
console.log(avgOdd);

//! OR
const newOdds = Object.values(game.odds);
let average = 0;
for (const odd of newOdds) average += odd;
average /= newOdds.length;
console.log(average);
// 3. Print the 3 odds to the console, but in a nice formatted way, exactly like this:
// Odd of victory Bayern Munich: 1.33
// Odd of draw: 3.25
